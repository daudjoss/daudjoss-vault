...
window.DASH = {"generated": "2026-08-05T00:32:41.733786+07:00", "build": "v10.1-max", "stats": {"total": 1, "success": 1, "failed": 0, "cancelled": 0, "running": 0, "rate": 100.0, "enc": 1, "enc_ok": 0, "enc_rate": 0.0, "today": 0, "today_ok": 0, "streak": 0, "best": 0, "top_hour": 17, "top_day": "Wednesday", "total_size": 0.0009, "storage_est": false, "lifetime_est_gb": 0.82, "gh_bytes": 1000000, "night": 0, "avg_duration": 300.0}, "hours": {"17": 1}, "days": {"Wednesday": 1}, "daily": {"2025-01-01": 1}, "insights": ["Kamu paling sering rekam jam 17:00", "Hari paling aktif: Wednesday", "Success rate 100.0% \u2014 excellent!"], "predictions": ["Volume rekaman lifetime ~0.8 GB (est) \u2014 di Telegram, bukan di GitHub", "GitHub storage aktual: 976.6 KB (manifest .txt; encode-temp dibersihkan)"], "runs": [{"databaseId": 1, "name": "rusemeva-vault", "status": "completed", "conclusion": "success", "createdAt": "2025-01-01T10:00:00Z", "updatedAt": "2025-01-01T10:05:00Z", "event": "push", "headBranch": "main", "headSha": "abc123", "runNumber": 1, "displayTitle": "test", "orv_id": "", "source": ""}, {"databaseId": 2, "name": "rusemeva-encode", "status": "completed", "conclusion": "failure", "createdAt": "2025-01-01T11:00:00Z", "updatedAt": "2025-01-01T11:03:00Z", "event": "push", "headBranch": "main", "headSha": "def456", "runNumber": 2, "displayTitle": "test2", "orv_id": "", "source": ""}], "releases": [{"tag": "v1.0", "name": "Release 1h30m", "created": "2025-01-01T12:00:00Z", "size": 1000000}]};
...
var randData='<code>1</code> | 580h | <a href="https://github.com/daudjoss/daudjoss-vault/actions/runs/1" target="_blank">View ↗</a>';
var cc={b:'rgba(88,166,255,.5)',g:'#3fb950',r:'#f85149'};
new Chart(document.getElementById('c1').getContext('2d'),{type:'bar',data:{labels:["2025-01-01"],datasets:[{data:[1],backgroundColor:cc.b,borderRadius:2}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},scales:{x:{grid:{color:'rgba(48,54,61,.4)'},ticks:{color:'#8b949e',maxTicksLimit:6,font:{size:9}}},y:{beginAtZero:true,grid:{color:'rgba(48,54,61,.4)'},ticks:{color:'#8b949e',stepSize:1,font:{size:9}}}}}});
new Chart(document.getElementById('c2').getContext('2d'),{type:'line',data:{labels:["2025-W00"],datasets:[{label:'OK',data:[1],borderColor:cc.g,backgroundColor:'rgba(63,185,80,.08)',fill:true,tension:.4},{label:'Fail',data:[0],borderColor:cc.r,backgroundColor:'rgba(248,81,73,.08)',fill:true,tension:.4}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{labels:{color:'#8b949e',font:{size:9}}}},scales:{x:{grid:{color:'rgba(48,54,61,.4)'},ticks:{color:'#8b949e',font:{size:9}}},y:{beginAtZero:true,grid:{color:'rgba(48,54,61,.4)'},ticks:{color:'#8b949e',stepSize:1,font:{size:9}}}}}});
