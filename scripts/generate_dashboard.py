...
<div class="theme-opt sel" data-theme="dark" onclick="setTheme('dark')"><div class="theme-swatch dark"></div><div class="theme-opt-icon">🌙</div><div class="theme-opt-label">Dark</div></div>
<div class="theme-opt" data-theme="light" onclick="setTheme('light')"><div class="theme-swatch light"></div><div class="theme-opt-icon">☀️</div><div class="theme-opt-label">Light</div></div>
<div class="theme-opt" data-theme="ocean" onclick="setTheme('ocean')"><div class="theme-swatch ocean"></div><div class="theme-opt-icon">🌊</div><div class="theme-opt-label">Ocean</div></div>
<div class="theme-opt" data-theme="forest" onclick="setTheme('forest')"><div class="theme-swatch forest"></div><div class="theme-opt-icon">🌲</div><div class="theme-opt-label">Forest</div></div>
</div></div>
...
if(t==='music'){h.textContent='🎵 Radio Indonesia';var radioStations=[{n:'Radio Elshinta',u:'https://stream2.elshinta.com/live'},{n:'Prambors FM',u:'https://prambors.simaya.co.id/stream'},{n:'Gen FM Jakarta',u:'https://streaming.jazzradio.net/genfm'},{n:'RRI Pro 1',u:'https://rri1-streaming.simaya.co.id/stream'},{n:'Hard Rock FM',u:'https://hardrockfm.simaya.co.id/stream'},{n:'I-Radio Jakarta',u:'https://iradio.simaya.co.id/stream'},{n:'Dangdut Radio',u:'https://stream.laut.fm/dangdut'}];b.innerHTML='<audio id="radioPlayer" controls style="width:100%;margin-bottom:8px"></audio><div style="font-size:11px;color:var(--t2);margin-bottom:8px">Pilih stasiun radio:</div><div id="radioList"></div><div id="radioNowPlaying" style="font-size:10px;color:var(--bl);margin-top:8px"></div>';var rl=document.getElementById('radioList');if(rl){var html2='';radioStations.forEach(function(s,idx){html2+='<button class="quick-btn radio-btn" data-rurl="'+s.u+'" data-rname="'+s.n+'">📻 '+s.n+'</button>'});rl.innerHTML=html2}}
}
