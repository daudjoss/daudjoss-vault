...
if(t==='music'){h.textContent='🎵 Radio Indonesia';var radioStations=[{n:'Elshinta FM Jakarta',u:'https://stream-ssl.arenastreaming.com:8000/jakarta'},{n:'Mettaswara Koplo',u:'https://mettaswara.com:8700//koplo'},{n:'Campur Sari 89.2 FM',u:'https://a8.siar.us/listen/campursari/stream'},{n:'Suara Soneta',u:'https://a2.siar.us//listen//suarasoneta//radio.mp3'},{n:'Beat Radio Dangdut',u:'https://stream.beatradioid.com:8000//dangdut'},{n:'Dengerin Musik Indonesia',u:'https://stream.denger.in/'},{n:'Sunda Radio',u:'https://sundaradio.com/live/sundaradio'},{n:'CLASSY NetRadio',u:'https://streaming.classynetradio.com:8000/classySD'},{n:'POP FM Semarang',u:'https://i.klikhost.com:9612/stream.aac'},{n:'Style 94.6 FM Tasikmalaya',u:'https://stream.stylefmtasik.com/listen/stylefmtasik/stream'},{n:'Suara Salira',u:'https://live.suarasalira.com/listen/suarasalira/stream'},{n:'Mettaswara Dangdut',u:'https://mettaswara.com:8700/d4d'},{n:'Radio Patria 102.6 FM',u:'https://streaming.radiopatria.net/radio/8000/patria'},{n:'Campursari FM Jakarta',u:'https://streaming.campursarifm.com/listen/campursari/campursari892'},{n:'Dark Symphony Radio',u:'https://streaming.live365.com/a02267'},{n:'StarStream Vinyl Vibe',u:'https://streaming.live365.com/a29175'},{n:'StarStream Classic Rock',u:'https://streaming.live365.com/a76931'},{n:'Golden Hits FM',u:'https://i.klikhost.com:9134/stream'},{n:'Alternatif Radio Jakarta',u:'https://void.idserverhost.com/8016/stream'}];b.innerHTML='<audio id="radioPlayer" controls style="width:100%;margin-bottom:8px"></audio><div style="font-size:11px;color:var(--t2);margin-bottom:8px">Pilih stasiun radio:</div><div id="radioList"></div><div id="radioNowPlaying" style="font-size:10px;color:var(--bl);margin-top:8px"></div>';var rl=document.getElementById('radioList');if(rl){var html2='';radioStations.forEach(function(s,idx){html2+='<button class="quick-btn radio-btn" data-rurl="'+s.u+'" data-rname="'+s.n+'">📻 '+s.n+'</button>'});rl.innerHTML=html2}}
}
